...
namespace Challenge.Common.Decorators.AuditLog
{
        ...
        where TQuery : IQuery<TResult>
    {
        ...
        private readonly ILogger<AuditLogQueryDecorator<TQuery, TResult>> logger;

        public AuditLogQueryDecorator(
            IQueryHandler<TQuery, TResult> handler,
            Microsoft.Extensions.Logging.ILogger<AuditLogQueryDecorator<TQuery, TResult>> logger
            )
        {
            _handler = handler;
            this.logger = logger;
        ...
        public async Task<TResult> Handle(TQuery query)
        {
            ...
            ColorConsole.WriteEmbeddedColorLine(
                $"[darkcyan]Query of type[/darkcyan] [yellow]{query.GetType().Name}[/yellow]: [darkcyan]{queryJson}[/darkcyan]");
