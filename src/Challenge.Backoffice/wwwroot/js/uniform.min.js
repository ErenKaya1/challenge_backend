!(function (e, t, n) {
  ...
  function d(e, n, a) {
    ...
    return (
      a || (a = {}),
      (a = t.extend({ bind: {}, divClass: null, divWrap: "wrap", spanClass: null, spanHtml: null, spanWrap: "wrap" }, a)),
      (i = t("<div />")),
      (r = t("<span />")),
    ...
    W = [
                ...
                return (
                  ...
                  t[0].dispatchEvent
                    ? ((n = document.createEvent("MouseEvents")),
                      ...
                      t.is("a") && a && ((i = s(t, "target")), (r = s(t, "href")), i && "_self" !== i ? e.open(r, i) : (document.location.href = r)))
                    : t.click(),
                  void (p = !1))
                );
              },
      ...
      },
      {
        ...
        apply: function (e, n) {
          ...
          return (
            (u = d(e, n, { divClass: n.fileClass, spanClass: n.fileButtonClass, spanHtml: h ? n.filesButtonHtml : n.fileButtonHtml, spanWrap: "after" })),
            (f = u.div),
            (m = u.span),
      ...
      },
      {
        ...
        apply: function (e, n) {
          ...
          return (
            ...
            (s = d(e, n, { divClass: n.selectClass, spanHtml: (e.find(":selected:first") || e.find("option:first")).html(), spanWrap: "before" })),
            (l = s.div),
            (u = s.span),
            n.selectAutoWidth
              ? k(e, function () {
  ...
  v() && !h() && (x = !1),
    ...
    (t.uniform.restore = t.fn.uniform.restore =
      function (e) {
    ...
    (t.uniform.update = t.fn.uniform.update =
      function (e) {
        e === n && (e = t.uniform.elements),
          t(e).each(function () {
            var e,
